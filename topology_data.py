    ...
    def get_link_quality(self):
        ...
        for src, dst, value in self.graph.edges(data=True):
            if src != dst:
                ...
                else: free_bandwith = 0

                if 'src_link_usage' in value: src_link_usage = value['src_link_usage']
                else: src_link_usage = 0
                
                if 'dst_link_usage' in value: dst_link_usage = value['dst_link_usage']
