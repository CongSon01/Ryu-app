        ...
        try:
            ...
            for link in link_to_port:
                ...
                if src_dpid in free_bandwidth and dst_dpid in free_bandwidth:
                    ...
                    graph[src_dpid][dst_dpid]['free_bandwith'] = bandwidth    #Mbit/s
                    graph[src_dpid][dst_dpid]['link_usage'] = link_usage
                    graph[src_dpid][dst_dpid]['src_link_usage'] = src_link_usage 
                    graph[src_dpid][dst_dpid]['dst_link_usage'] = dst_link_usage  #Mbit/s
